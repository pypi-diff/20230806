# Comparing `tmp/cougar-0.3.2.tar.gz` & `tmp/cougar-0.3.3.tar.gz`
...
## Comparing `cougar-0.3.2.tar` & `cougar-0.3.3.tar`
...
### Comparing `cougar-0.3.2/LICENSE` & `cougar-0.3.3/LICENSE`
...
### Comparing `cougar-0.3.2/cougar/rolling.c` & `cougar-0.3.3/cougar/rolling.c`
...
### Comparing `cougar-0.3.2/pyproject.toml` & `cougar-0.3.3/pyproject.toml`
...
### Comparing `cougar-0.3.2/setup.py` & `cougar-0.3.3/setup.py`
