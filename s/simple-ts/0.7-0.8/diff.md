# Comparing `tmp/simple_ts-0.7.tar.gz` & `tmp/simple_ts-0.8.tar.gz`
...
## Comparing `simple_ts-0.7.tar` & `simple_ts-0.8.tar`
...
### Comparing `simple_ts-0.7/README.md` & `simple_ts-0.8/README.md`

 * *Files identical despite different names*

### Comparing `simple_ts-0.7/simplets/simplets.py` & `simple_ts-0.8/simplets/simplets.py`
